 ...
 * {@link sk.tomsik68.mclauncher.impl.versions.mcdownload.MCDownloadVersionList}
 * instead!
 *
 * @author Tomsik68
 */
...
public final class MCAssetsVersionList extends Observable<String> implements IVersionList {
	private static final Pattern snapshotPattern = Pattern
			.compile("((\\d\\d\\w\\d\\d\\w)|(\\d_\\d-pre)|(\\d_\\d-pre\\d)|(rc)|(rc\\d))");
	private static final LatestVersionInformation LATEST_VERSION_INFORMATION = new LatestVersionInformation("1_5_2",
			"13w11a");
	...
	public void startDownload() throws Exception {
		...
		for (int i = 0; i < doc.getElementsByTagName("ListBucketResult").item(0).getChildNodes().getLength(); i++) {
			...
			if ((node != null) && ("Contents".equalsIgnoreCase(node.getNodeName()))
