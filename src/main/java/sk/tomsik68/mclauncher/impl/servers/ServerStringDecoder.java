...
/**
 * Minecraft's open to lan option servers broadcast a string like
 * [AD]25565[/AD][MOTD]Tomsik68's server[/MOTD]. This class takes care of
 * extracting the property value. Just a string utility class then.
 */
