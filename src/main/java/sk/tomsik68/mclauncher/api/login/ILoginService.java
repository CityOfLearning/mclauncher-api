...
/**
 * Login Service is responsible for converting IProfile to ISession. It's up to
 * developer to choose login service.
 *
 */
public interface ILoginService extends IOnlineService {
	 ...
	 * @throws Exception
	 *             - Connection failed, or LoginException if login failed
	 */
