...
/**
 * This is used for compatibility with the official launcher. Launcher
 * visibility rules determine how the launcher behaves when you start game.
 *
 * @author Tomsik68
 */
public enum ELauncherVisibility {
	...
	/**
	 * Launcher is closed(exited, killed, whatever) when game is started and
	 * game is left alone.
	 */
