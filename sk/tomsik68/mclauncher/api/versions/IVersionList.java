...
/**
 * Version list contains versions. Versions are not saved, their IDs are passed
 * as they're being parsed. If you want IVersion object, you need to retrieve
 * the version
 *
 * @author Tomsik68
 */
public interface IVersionList extends IObservable<String> {
	 ...
	 * @throws Exception
	 *             - Network errors, JSON parsing errors
	 */
	 ...
	 *
	 * @param id
	 *            ID of version to retrieve (e.g. "1.8")
	 * @return IVersion object for the passed ID
	 * @throws Exception
	 *             - Network errors, JSON parsing errors, version inheritance
	 *             problems
	 */
