...
public interface IVersionInstaller {
	/**
	 * Adds listener to be notified when version installation finishes.
	 * <b>Listeners will be cleared after ONE installation.</b>
	 *
	 * @param listener
	 ...
	 * @param mc
	 *            Target MinecraftInstance
	 * @param progress
	 *            ProgressMonitor which will watch the whole progress
	 * @throws Exception
	 *             I/O errors, download errors, incompatibility etc.
	 */
