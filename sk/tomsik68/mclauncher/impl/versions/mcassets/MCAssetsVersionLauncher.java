...
public final class MCAssetsVersionLauncher implements IVersionLauncher {
	...
	@Override
	public List<String> getLaunchCommand(ISession session, MinecraftInstance mc, ServerInfo server, IVersion version,
		...
		if (mods != null) {
			MCLauncherAPI.log.warning(
					"You're trying to use mods with MCAssets version. MCAssets versions are deprecated, so mods won't load correctly.");
		}
		return command;
	}
